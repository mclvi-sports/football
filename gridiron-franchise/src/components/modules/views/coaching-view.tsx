...
import { getCoaching, getCachedStats, storeCoaching } from '@/lib/coaching/coaching-store';
      ...
      return (
        <Card className="border-dashed">
          <CardContent className="p-8 text-center">
            ...
            <p className="text-sm text-muted-foreground">No coaching data available</p>
          </CardContent>
        </Card>
      );
    }
