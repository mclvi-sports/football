...
export function GMSkillsView({ mode, maxHeight = mode === 'embedded' ? '500px' : undefined }: GMSkillsViewProps) {
  ...
  return (
    <div
      className={cn('space-y-6', mode === 'embedded' && 'overflow-y-auto')}
      style={maxHeight ? { maxHeight } : undefined}
    >
      {/* Header Row (embedded shows compact view) */}
      {mode === 'embedded' && (
